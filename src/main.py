...
def validate_config(
    ...
    try:
            ...
            try:
                ...
                if target_db and target_schema and target_table:
                    ...
                    if create_control_table(
                        ...
                        console.print("[yellow]⚠ Warning: Could not verify control table[/yellow]")
                else:
                    console.print(
        ...
        table.add_row("MotherDuck Configs", str(validation_results["motherduck_configs_count"]))
...
def run(
    ...
    try:
        ...
        if (
            ...
            console.print()
            console.print(
                "[dim]Run: [bold]streamduck validate-config --show-rbac[/bold] for detailed guidance[/dim]"
            )
        else:
            ...
            console.print(
                "   • Run: [bold]streamduck validate-config[/bold] to check configuration"
            )
            console.print(
                "   • Run: [bold]streamduck validate-config --show-rbac[/bold] for permission guidance"
            )
